...
<<<<<<< HEAD
                DataController.instance.gameData.myItemCount[
                    obj.transform.GetChild(0).GetComponent<Pickup>().item.itemName] = 1;
        ...
        if (DataController.instance.gameData.myItemCount.ContainsKey(theItem.GetComponent<Pickup>().item.itemName))
        {
            ...
            if (theItem.GetComponent<Pickup>().item.itemType == Item.ItemType.Ingredient || theItem.layer == 8)
            {
                GameObject temp =
                    mySlots[
                            DataController.instance.gameData.savedInventory[
                                theItem.GetComponent<Pickup>().item.itemName]]
                        .transform.GetChild(0).gameObject;
                GameObject obj = temp.transform.GetChild(1).gameObject;
                obj.transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = DataController.instance.gameData
                    .myItemCount[theItem.GetComponent<Pickup>().item.itemName].ToString();
=======
