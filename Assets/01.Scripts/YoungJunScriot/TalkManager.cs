...
=======
        ...
        talkData.Add(32 + 2000, new string[]{"뭐야 ? ! ? !\n여우꼬리 가죽아니야 ? !:0",
                                              ...
                                              "고마워 ! 답례라고 하긴 그렇고 \n무기날이 많이상한거같은데 건너편 NPC한테 가봐 !:1",
                                              "무기강화도 할 수 있고 필요한 아이템도 판매하고 있대 \n . . . 그리고 혹시 한가지만 더 도와 줄 수 있을까 ?:0",
                                              "사실 "+"<color=red>"+"여우들을 통솔하는 왕이 있어"+"</color>"+"\n그 녀석을 좀 처리해줄 수 있어 ?:0",
                                              "..너라면 믿을 수 있을 것 같아:1",
                                              "생김새는 일반여우랑 똑같이 생겼는데 엄청 큰 녀석이있어\n듣기에는 엄청강하다니까 좋은무기를 들고가는게 좋을 것 같아:1"});
        ...
        talkData.Add(41 + 3000, new string[]{". . . . . . . .:0",
                                              ...
                                              ". . . 고맙네, 그럼 기다리겠네\n부디 몸 조심하게.:0"});
        talkData.Add(42 + 3000, new string[] {". . . 자네군 . .\n다친데는 없나 ?:0",
                                              "고맙네, 자네가 가져온 뿔을 조사해볼테니\n나중에 다시 들러주겠나?:1"});
        talkData.Add(43 + 1000, new string[] {"오빠 ! ! 웬일이야\n클레보러 왔어 ? ㅎㅎ:1",
                                              "마침 내가 오빠 찾고 있는줄은 어떻게 알고 !:0",
                                              "다름이 아니라 클레가 우유가 먹고싶은데 . .\n한창 클 나이이잖아 ! !:0",
                                              "마을 입구로나가서 오른편으로 가면\n젖소목장이 있어 !:0",
                                              "거기서"+"<color=red>"+"밀크카우"+"</color>"+"를 잡아서\n우유를좀 구해줘 ! 구 해 줄 꺼 지 ?:1",
                                              "웅 구해줄꺼지 ?:0"});
        talkData.Add(44 + 1000, new string[] {"오빠 ! 우유는 ?:0",
                                              "헤헤 고마워 !\n클레 빨리 키커서 오빠한테 시집갈거야 !:1"});
        talkData.Add(45 + 3000, new string[] {"아, 자네 왔는가:0",
                                              "마침 조사도 방금 끝났네:0",
